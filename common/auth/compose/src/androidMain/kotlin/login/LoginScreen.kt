...
fun LoginScreen() {
    StoredViewModel(factory = {
        ...
        val isPasswordHidden = state.value.passwordHidden
        ...
        Column(
            ...
            TextField(
                ...
                placeholder = {
                    Text(text = "Email Address", color = Theme.colors.hintTextColor)
                })
            ...
            TextField(
                ...
                trailingIcon = {
                    Icon(
                        ...
                        imageVector = if (isPasswordHidden) Icons.Outlined.Clear
                ...
                enabled = !state.value.isSending,
                placeholder = {
                    Text(text = "Password", color = Theme.colors.hintTextColor)
                })
